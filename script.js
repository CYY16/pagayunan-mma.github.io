...
const weekData = [
  {
    ...
    content: "Selected the source video and researched rotoscope techniques. Watched tutorials on using the Roto Brush tool in Adobe After Effects."
  },
  {
    title: "Week 2 — Setup",
    content: "Installed and set up After Effects and CapCut. Learned the basics of composition settings and timeline navigation."
  },
  {
